...
injector.registerLazySingleton<SearchProducts>(() =>  SearchProducts(productsRepo: injector.get<ProductsRepoImpl>()));
injector.registerFactory<ProductsCubit>(() => ProductsCubit(searchProducts: injector.get<SearchProducts>(), getProductsUseCase: injector.get<GetProductsUseCase>(), getProductsByCategoryUseCase: injector.get<GetProductsByCategoryUseCase>(), getProduct: injector.get<GetProduct>()));
...
injector.registerLazySingleton<CheckoutItems>(() => CheckoutItems(cartRepo: injector.get<CartRepoImpl>()));
injector.registerLazySingleton<CartCubit>(() => CartCubit(checkoutItems: injector.get<CheckoutItems>(), addCartItem: injector.get<AddCartItem>(), deleteCartItem: injector.get<DeleteCartItem>(), getCartItems: injector.get<GetCartItems>(), getProduct: injector.get<GetProduct>()));

///search 
injector.registerFactory<ProductsSearchCubit>(() => ProductsSearchCubit());
